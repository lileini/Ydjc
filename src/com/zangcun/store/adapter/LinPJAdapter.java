...
import com.zangcun.store.model.LinPJModel;

import java.util.List;

//待评价适配器
public class LinPJAdapter extends BaseAdapter {
    private Context mContext;
    private List<LinPJModel> mDataList;

    public LinPJAdapter(Context mContext, List<LinPJModel> mDataList) {
    ...
    @Override
    public LinPJModel getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.btn_go_pj = (Button) convertView.findViewById(R.id.btn_go_pay);
    ...
    static class ViewHolder {
        ...
        private Button btn_go_pj;//去评价按钮
    }
}
